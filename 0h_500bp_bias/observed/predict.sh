...
CUDA_VISIBLE_DEVICES=$gpu kerasAC_predict_tdb \
		    ...
		    --tdb_bias_arrays /oak/stanford/groups/akundaje/projects/enzymatic_bias_correction/tiledb/SRR072187 /oak/stanford/groups/akundaje/projects/enzymatic_bias_correction/tiledb/SRR072187 \
